        ...
        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left relative z-10">
          ...
          <div className="w-full space-y-4 max-w-md">
            ...
            <div className="flex items-center justify-between p-4 bg-white/60 rounded-2xl clay-pill border border-white/40">
              ...
              <div className="flex items-center gap-4">
                <span className="text-xl font-bold text-brand-orange">₹900</span>
                <a href="https://wa.me/919653614716?text=Hello!%20I%20would%20like%20to%20order%20the%206%20Piece%20Box%20-%20Medium%20Size%20for%20%E2%82%B9900." target="_blank" rel="noreferrer" className="bg-brand-yellow text-brand-brown px-5 py-2 rounded-full text-xs font-bold hover:bg-brand-orange hover:text-white clay-btn-primary transition-colors">
                  Order
                </a>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-4 bg-white/60 rounded-2xl clay-pill border border-white/40">
              ...
              <div className="flex items-center gap-4">
                <span className="text-xl font-bold text-brand-orange">₹750</span>
                <a href="https://wa.me/919653614716?text=Hello!%20I%20would%20like%20to%20order%20the%206%20Piece%20Box%20-%20Small%20Size%20for%20%E2%82%B9750." target="_blank" rel="noreferrer" className="bg-brand-yellow text-brand-brown px-5 py-2 rounded-full text-xs font-bold hover:bg-brand-orange hover:text-white clay-btn-primary transition-colors">
                  Order
                </a>
              </div>
            </div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <FadeIn delay={0.1}>
              <div className="bg-[#FAF4E1] rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-8 flex flex-col items-center text-center clay-card-strong hover:-translate-y-2 transition-transform duration-300 group h-full">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between w-full mt-auto pt-4 border-t border-black/5 gap-4 sm:gap-0">
                  <span className="text-2xl font-bold text-brand-brown">₹2,100</span>
                  <a href="https://wa.me/919653614716?text=Hello!%20I%20would%20like%20to%20order%20the%20King%20Size%20(Large)%20Mangoes%20(1%20Dozen)%20for%20%E2%82%B92,100." target="_blank" rel="noreferrer" className="w-full sm:w-auto bg-brand-yellow text-brand-brown px-6 py-2.5 rounded-full text-sm font-bold hover:bg-brand-orange hover:text-white clay-btn-primary text-center">
                    Order Now
                  </a>
                </div>
              </div>
            ...
            <FadeIn delay={0.2}>
              <div className="bg-[#FAF4E1] rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-8 flex flex-col items-center text-center clay-card-strong hover:-translate-y-2 transition-transform duration-300 group h-full relative">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between w-full mt-auto pt-4 border-t border-black/5 gap-4 sm:gap-0">
                  <span className="text-2xl font-bold text-brand-brown">₹1,700</span>
                  <a href="https://wa.me/919653614716?text=Hello!%20I%20would%20like%20to%20order%20the%20Medium%20Size%20Mangoes%20(1%20Dozen)%20for%20%E2%82%B91,700." target="_blank" rel="noreferrer" className="w-full sm:w-auto bg-brand-yellow text-brand-brown px-6 py-2.5 rounded-full text-sm font-bold hover:bg-brand-orange hover:text-white clay-btn-primary text-center">
                    Order Now
                  </a>
                </div>
              </div>
